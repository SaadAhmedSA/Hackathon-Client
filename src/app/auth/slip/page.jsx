    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
      <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
        ...
        <div className="mb-6">
          ...
          <p className="text-lg font-semibold">CNIC: <span className="font-normal">{cnic}</span></p>
          <p className="text-lg font-semibold">Email: <span className="font-normal">{email}</span></p>
          <p className="text-lg font-semibold">Purpose: <span className="font-normal">{purpose}</span></p>
          <p className="text-lg font-semibold">Loan Amount: <span className="font-normal">{loanAmount}</span></p>
          <p className="text-lg font-semibold">Monthly Payment: <span className="font-normal">{monthlyPayment}</span></p>
        </div>
